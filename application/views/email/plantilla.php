								...
								<tr>
									<td name="bmeMainColumnParent" style="border: 0px none transparent; border-radius: 0px; border-collapse: separate;">       
										<table name="bmeMainColumn" class="bmeHolder bmeMainColumn" style="max-width: 600px; border-radius: 0px; border-collapse: separate; border-spacing: 0px; overflow: visible;" cellspacing="0" cellpadding="0" border="0" align="center">
											<tbody>
												<tr>
													<td width="100%" class="blk_container bmeHolder" name="bmePreHeader" valign="top" align="center" style="color: rgb(102, 102, 102); border: 0px none transparent; background-color: rgb(253, 50, 51);" bgcolor="#00ae54"></td>
												</tr>
												<tr>
													<td width="100%" class="bmeHolder" valign="top" align="center" name="bmeMainContentParent" style="border: 0px none rgb(102, 102, 102); border-radius: 0px; border-collapse: separate; border-spacing: 0px; overflow: hidden;">    
															<table name="bmeMainContent" style="border-radius: 0px; border-collapse: separate; border-spacing: 0px; border: 0px none transparent;" width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
																<tbody>
																	<tr>
																		<td width="100%" class="blk_container bmeHolder" name="bmeHeader" valign="top" align="center" style="color: rgb(56, 56, 56); border: 0px none transparent; background-color: rgb(253, 50, 51);" bgcolor="#00ae54">
																									...
																									<tbody>
																										<tr>
																											<td align="center" class="bmeImage" style="border-collapse: collapse; padding: 20px;">
																												<img src="images/logo.png" width="52" style="max-width: 150px; display: block; width: 150px;" border="0">
																											</td>
																										</tr>
																									</tbody>    
																								</table>
																										...
																										<tr>
																											<td class="tdPart" valign="top" align="center">    
																												<table cellspacing="0" cellpadding="0" border="0" width="600" name="tblText" style="float:left; background-color:transparent;" align="left" class="tblText">
																													<tbody>
																														<tr>
																															<td valign="top" align="left" name="tblCell" style="padding: 10px 10px; font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-weight: 400; color: rgb(56, 56, 56); text-align: left;" class="tblCell">
																																<div style="line-height: 150%; text-align: left;">
																																	<span style="font-size: 16px;/*font-family: 'Courier New';*/ font-family: 'Helvetica', Courier; color: #464646; line-height: 150%;">
																																		<strong>{CUERPO1}</strong>
																																	</span>    
																																	<!-- <span style="font-size: 14px; font-family: 'Courier New', Courier; color: #464646; line-height: 150%;">Here's a token of our appreciation.</span> -->
																																</div>
																															</td>
																														</tr>
																													</tbody>    
																										...
																										<tr>
																											<td align="center">    
																												<table cellspacing="0" cellpadding="0" border="0" class="bmeButton" align="center" style="border-collapse: separate;">
																													<tbody>
																														<tr>
																															<td style="border-radius: 0px; border: 3px solid rgb(253, 50, 51); text-align: left; font-family: Arial, Helvetica, sans-serif; font-size: 14px; padding: 15px 30px; /*font-weight: bold;*/ border-collapse: separate;" class="bmeButtonText">
																																<span style="/*font-family: 'Courier New', Courier;*/ font-size: 14px; color: rgb(66, 66, 66);">    
																																	<a style="color: rgb(66, 66, 66); /*text-decoration: none;*/" target="_blank">{CUERPO2}</a>
																																</span>
																															</td>
																														</tr>
																													</tbody>    
																						...
																						<tr>
																							<td>    
																								<table width="100%" cellspacing="0" cellpadding="0" border="0">
																									<tbody>
																										<tr>
																											<td align="center" class="bmeImage" style="border-collapse: collapse; padding: 20px 0px;">
																												<img src="https://benchmarkemail.com/images/templates_n/new_editor/Templates/Outdoors/AdventureHeader.jpg" class="mobile-img-large" width="600" style="max-width: 1200px; display: block; width: 600px;" alt="" border="0">
																											</td>
																										</tr>
																									</tbody>    
																								</table>
																														...
																														<tr>
																															<td valign="top" align="left" name="tblCell" style="padding: 10px 20px; font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-weight: 400; color: rgb(56, 56, 56); text-align: left;" class="tblCell">
																																<div style="line-height: 200%;">
																																	<span style="font-size: 14px; font-family: 'Courier New', Courier; color: #464646; line-height: 200%;">Thanks for signing up to receive our monthly updates. We have so much to share with you. We receive a weekly refresh of inventory showcasing the latest and greatest in outdoor tools and apparel from the most exciting new companies in the game. Backpacks, wool socks, hiking boots, beanies, tech outerware that is practical but with a roadworthy edge.</span>
																																	<br>    
																																	<br>
																																	<span style="font-size: 14px; font-family: 'Courier New', Courier; color: #464646; line-height: 200%;">Our recently redesigned website also includes a place to share you stories and hiking trails. Every month we feature a guest hiker who will post exciting new photos and tips for your next expedition.
																																	</span>
																																</div>
																															</td>
																														</tr>
																	...
																	<tr>
																		<td width="100%">     
																			<table class="bmeHolder" name="bmeBody" cellspacing="0" cellpadding="0" border="0" align="center" width="100%" style="color: rgb(56, 56, 56); border: 0px none transparent; background-color: rgb(255, 255, 255);" bgcolor="#ffffff">
																				<tbody>
																					<tr>
																						<td width="100%" valign="top" align="center">
																							<div>    
																										...
																										<tr>
																											<!-- <td valign="top" align="center" width="50%" class="tdPart">
																												<table cellspacing="0" cellpadding="0" border="0" width="100%" class="bmeHolder1" style="float:left;" align="left">
																													<tbody>
																														<tr>
																															<td valign="top" align="center" class="blk_container bmeLeftColumn" name="bmeLeftColumn" style="  " bgcolor="">
																																<div id="dv_4" class="blk_wrapper" style="">    
																																	<table width="300" cellspacing="0" cellpadding="0" border="0" class="blk" name="blk_button">
																																		<tbody>
																																			<tr>
																																				<td width="20"></td>
																																				<td align="center">    
																																					<table class="tblContainer" cellspacing="0" cellpadding="0" border="0" width="100%">
																																						<tbody>
																																							...
																																							<tr>
																																								<td align="center">    
																																									<table cellspacing="0" cellpadding="0" border="0" class="bmeButton" align="center" width="100%" style="border-collapse: separate;">
																																										<tbody>
																																											<tr>
																																												<td style="border-radius: 0px; border: 3px solid rgb(253, 50, 51); text-align: center; font-family: Arial, Helvetica, sans-serif; font-size: 14px; padding: 15px 30px; font-weight: bold; border-collapse: separate; background-color: rgb(253, 50, 51);" class="bmeButtonText">
																																													<span style="font-family: 'Courier New', Courier; font-size: 14px; color: rgb(255, 255, 255);">    
																																														<a style="color: rgb(255, 255, 255); text-decoration: none;" target="_blank">Read Stories</a>
																																													</span>
																																												</td>
																																											</tr>
																																										</tbody>    
																											...
																											<!-- <td valign="top" align="center" width="50%" class="tdPart">     
																												<table cellspacing="0" cellpadding="0" border="0" width="100%" class="bmeHolder1" style="float:right;" align="right">
																													<tbody>
																														<tr>
																															<td valign="top" align="center" class="blk_container bmeRightColumn" name="bmeRightColumn" style="  " bgcolor="">
																																<div id="dv_21" class="blk_wrapper" style="">    
																																	<table width="300" cellspacing="0" cellpadding="0" border="0" class="blk" name="blk_button" style="">
																																		<tbody>
																																			<tr>
																																				<td width="20"></td>
																																				<td align="center">    
																																							...
																																							<tr>
																																								<td align="center">    
																																									<table cellspacing="0" cellpadding="0" border="0" class="bmeButton" align="center" width="100%" style="border-collapse: separate;">
																																										<tbody>
																																											<tr>
																																												<td style="border-radius: 0px; border: 3px solid rgb(253, 50, 51); text-align: center; font-family: Arial, Helvetica, sans-serif; font-size: 14px; padding: 15px 30px; font-weight: bold; border-collapse: separate;" class="bmeButtonText">
																																													<span style="font-family: 'Courier New', Courier; font-size: 14px; color: rgb(66, 66, 66);">    
																																														<a style="color: rgb(66, 66, 66); text-decoration: none;" target="_blank">20% Off First Purchase</a>
																																													</span>
																																												</td>
																																											</tr>
																																										</tbody>    
																						...
																						<tr>
																							<td>    
																								<table cellpadding="0" cellspacing="0" border="0" width="100%" class="bmeContainerRow">
																									<tbody>
																										<tr>
																											<td class="tdPart" valign="top" align="center" style="background-color: rgb(96, 84, 72);">    
																												<table cellspacing="0" cellpadding="0" border="0" width="600" name="tblText" style="float: left; background-color: rgb(96, 84, 72);" align="left" class="tblText">
																													<tbody>
																														<tr>
																															<td valign="top" align="left" name="tblCell" style="padding: 20px; font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-weight: 400; color: rgb(56, 56, 56); text-align: left;" class="tblCell">
																																<div style="line-height: 150%; text-align: center;">
																																	<span style="font-size: 20px; font-family: 'Courier New', Courier; color: #ffffff; line-height: 150%;">{CUERPO3}</span>    
																																	<br>
																																	<span style="font-size: 14px; font-family: 'Courier New', Courier; color: #ffffff; line-height: 150%;">    
																																	<!-- <br>— Henry Billings, Weekend Explorer -->
																																	</span>
																																</div>
																															</td>
																														</tr>
																												...
																												<table cellspacing="0" cellpadding="0" border="0" width="600" name="tblText" style="float:left; background-color:transparent;" align="left" class="tblText">
																													<tbody>
																														<tr>
																															<td valign="top" align="left" name="tblCell" style="padding: 20px; font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-weight: 400; color: rgb(56, 56, 56); text-align: left;" class="tblCell">
																																<div style="line-height: 200%;">
																																	<span style="font-size: 14px; font-family: 'Courier New', Courier; color: #464646; line-height: 200%;">- El equipo de Market Experts</span>
																																</div>
																															</td>
																														</tr>
																													</tbody>    
																									...
																									<tbody>
																										<tr>
																											<td align="center" class="bmeImage" style="border-collapse: collapse; padding: 0px;">
																												<img src="https://benchmarkemail.com/images/templates_n/new_editor/Templates/Outdoors/Boots.jpg" class="mobile-img-large" width="600" style="max-width: 1200px; display: block; width: 600px;" alt="" border="0">
																											</td>
																										</tr>
																									</tbody>    
																								</table>
																															...
																															<td valign="top" name="bmeSocialTD" class="bmeSocialTD">--><!--[if gte mso 6]></td><td align="left" valign="top"><![endif]-->    
																																...
																																<!-- <table cellspacing="0" cellpadding="0" border="0" class="bmeFollowItem" type="twitter" style="float: left; display: block;" align="left">
																																	<tbody>
																																		<tr>
																																			<td align="left" class="bmeFollowItemIcon" gutter="20" width="24" style="padding-right:20px;height:20px;">    
																																				<a href="http://benchmarkemail.benchurl.com/c/l?u=5EE6FDD&e=8E4B52&c=91CEA&t=1&l=7889F345&email=hL2iimIGZvj2QooSzVze1t7P%2FZjRPRKrj2c0%2B7DqUhU%3D&seq=1" target=_blank  style="display: inline-block;background-color: rgb(253, 50, 51);border-radius: 0px;border-style: none; border-width: 0px; border-color: rgba(0, 0, 0, 0);" target="_blank">
																																	...
																																	<tbody>
																																		<tr>
																																			<td align="left" class="bmeFollowItemIcon" gutter="20" width="24" style="height:20px;">    
																																				<a href="mailto:" style="display: inline-block;background-color: rgb(253, 50, 51);border-radius: 0px;border-style: none; border-width: 0px; border-color: rgb(0, 0, 238);" target="_blank">
																					...
																					<tbody>
																						...
																						<!-- <tr>
																							<td name="bmeBadgeImage" style="text-align: left; padding-top: 20px; word-break: break-word;" align="left">    
																								<a href="http://www.benchmarkemail.com?p=500289" target="_new">
																									<img src="https://www.benchmarkemail.com/images/web4/misc/emailfooter/opt12.png"  style="max-width:144px;" border=0 />
																								</a>
																							</td>
																						</tr> -->
																					</tbody>    
